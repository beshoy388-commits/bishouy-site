...
The other three semifinalists are Real Madrid, who convincingly beat Manchester City 3-1, Paris Saint-Germain, who won 2-0 against Atlético Madrid, and Inter, who eliminated Borussia Dortmund thanks to a Lautaro Martínez brace.`,
  ...
  },
  {
    ...
    title: "Italian Startup Becomes Unicorn: 1.2 Billion Valuation for Milan Fintech",
    excerpt: "Payflow, the Milan-based startup specializing in B2B payments, reaches 1.2 billion dollar valuation after Series C funding round.",
...
"We started with the idea of solving a problem we knew well: Italian SMEs lose an average of 40 days per year managing payments," explained CEO Alessandro Ricci. "Today that solution works across all of Europe."`,
  ...
  },
  {
    ...
    title: "Arctic: Sea Ice Reaches Historic Minimum. Scientists Sound the Alarm",
    excerpt: "Satellite measurements confirm that Arctic sea ice extent has reached the lowest level ever recorded, with unpredictable consequences for global climate.",
