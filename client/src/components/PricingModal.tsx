          ...
          <div className="flex-1 flex flex-col overflow-hidden">
                      ...
                      return (
                        <div 
                          ...
                          className={`relative p-6 md:p-10 border rounded-sm transition-all cursor-pointer ${
                            isSelected ? 'bg-[#1C1C1A] border-[#E8A020]' : 'bg-[#0C0C0B] border-[#1C1C1A]'
                          }`}
                        >
              ...
              <div className="shrink-0 p-5 md:p-8 border-t border-[#1C1C1A] bg-[#0C0C0B] flex flex-col md:flex-row items-center justify-between gap-6 pb-[calc(1.25rem+env(safe-area-inset-bottom))]">
                  ...
                  <button 
                   ...
                   className="w-full md:w-auto bg-[#E8A020] hover:bg-[#D4911C] text-[#0F0F0E] px-10 py-4 font-900 text-[10px] uppercase tracking-widest disabled:opacity-50 transition-all"
                  >
        ...
        {view === "cancel_confirm" && (
           <div className="flex-1 flex items-center justify-center p-12">
              <div className="max-w-md w-full text-center">
                 ...
                 <button onClick={handleCancel} className="w-full bg-red-600 text-white py-4 font-900 uppercase text-[10px] tracking-widest mb-4">TERMINATE MEMBERSHIP</button>
