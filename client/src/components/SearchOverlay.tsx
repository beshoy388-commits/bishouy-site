                ...
                <div className="max-w-3xl mx-auto">
                    <div className="relative mb-12">
                        ...
                        <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2">
                            <span className="text-[9px] font-black text-[#555550] border border-[#2A2A28] px-1.5 py-0.5 rounded-sm uppercase tracking-widest hidden md:block">ESC to exit</span>
                    ...
                    {!query && (
                        <div className="mb-12 animate-in fade-in slide-in-from-top-4 duration-500">
                             <h5 className="font-ui text-[10px] font-black text-[#555550] uppercase tracking-[0.3em] mb-4">Trending Streams</h5>
                             <div className="flex flex-wrap gap-2">
                                {["World", "Technology", "Economy", "AI", "Culture", "Pulse"].map(cat => (
                                    <button 
                                        key={cat}
                                        onClick={() => setQuery(cat)}
                                        className="px-4 py-2 bg-[#1C1C1A] border border-[#2A2A28] text-[#8A8880] text-[10px] font-black uppercase tracking-widest rounded-full hover:border-[#E8A020] hover:text-[#E8A020] transition-all"
                                    >
                                        # {cat}
                                    </button>
                                ))}
