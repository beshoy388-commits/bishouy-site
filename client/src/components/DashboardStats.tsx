    ...
    <div className="space-y-12 animate-fade-in relative pb-20">
      ...
      <section className="flex flex-col xl:flex-row items-stretch justify-between gap-8 pb-10 border-b border-[#1C1C1A]">
        <div className="flex-1 space-y-4">
          <div className="flex items-center gap-3">
             <div className="px-2 py-1 bg-[#E8A020]/10 border border-[#E8A020]/20 rounded-sm">
                <span className="text-[10px] font-900 text-[#E8A020] uppercase tracking-[0.2em] font-ui">Operational Hub</span>
             </div>
             <div className="h-px w-12 bg-[#1C1C1A]" />
             <div className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-[#22c55e] animate-pulse" />
                <span className="text-[9px] font-800 text-[#555550] uppercase tracking-widest font-ui">Security Tier 1 Active</span>
             </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-6 items-center">
            ...
            <div className="w-full sm:w-56 p-6 bg-[#11110F] border border-[#1C1C1A] relative group overflow-hidden">
                ...
                <p className="text-[9px] font-900 text-[#555550] uppercase tracking-widest mb-4 font-ui">Broadcast Status</p>
            ...
            <Card className="bg-[#11110F] border-[#1C1C1A] p-8 h-48 relative overflow-hidden group hover:border-[#E8A020]/40 transition-all cursor-crosshair">
                ...
                <div className="mt-8">
                    <div className="flex items-end justify-between mb-2">
                        <p className="text-4xl font-display text-[#F2F0EB] font-900 tracking-tighter leading-none">
                            {stat.value.toLocaleString()}
                        </p>
                        <span className={`text-[10px] font-900 font-ui tracking-tighter ${stat.trendUp ? "text-green-500" : "text-red-500"}`}>
                            {stat.trend}
                        </span>
                    </div>
                    <p className="text-[10px] font-900 text-[#555550] uppercase tracking-[0.2em] font-ui border-t border-[#1C1C1A] pt-3">{stat.label}</p>
                </div>
            </Card>
          </motion.div>
        ))}
        ...
        <Card className="lg:col-span-2 bg-[#11110F] border-[#1C1C1A] p-0 overflow-hidden relative">
          <div className="p-8 border-b border-[#1C1C1A] flex items-center justify-between bg-[#141412]">
            <div className="flex items-center gap-4">
               ...
               <h3 className="text-[10px] font-900 text-[#F2F0EB] uppercase tracking-[0.3em] font-ui">Propagation Telemetry — SIGNAL_01</h3>
            </div>
            <div className="flex items-center gap-2">
               <span className="text-[9px] font-900 text-[#555550] uppercase tracking-widest font-ui">Mode: 7D Density Analysis</span>
            </div>
          </div>
        ...
        <div className="space-y-8">
          <Card className="bg-[#11110F] border-[#1C1C1A] p-0 overflow-hidden shadow-2xl">
            <div className="p-6 border-b border-[#1C1C1A] bg-[#141412]">
                <h3 className="text-[10px] font-900 text-[#555550] uppercase tracking-widest font-ui flex items-center gap-3">
                ...
                {[
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-[10px] font-900 text-[#8A8880] group-hover:text-[#F2F0EB] uppercase tracking-widest font-ui">{action.label}</span>
                        </div>
          ...
          <Card className="bg-[#11110F] border-[#1C1C1A] p-8 relative group overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-8 border-b border-[#1C1C1A] pb-4">
                    <h3 className="text-[10px] font-900 text-[#F2F0EB] uppercase tracking-[0.3em] font-ui">Core Stability</h3>
                    <div className="flex items-center gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-[#22c55e] animate-pulse" />
                        <span className="text-[9px] font-900 text-green-500 uppercase tracking-widest">Optimized</span>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="space-y-3">
                        <div className="flex justify-between items-center px-1">
                            <span className="text-[9px] font-900 text-[#555550] uppercase tracking-widest font-ui">Neural Load</span>
                            <span className="text-[10px] font-900 text-[#E8A020] font-display uppercase tracking-tighter">14.2%</span>
                        </div>
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between items-center px-1">
                            <span className="text-[9px] font-900 text-[#555550] uppercase tracking-widest font-ui">Sync Latency</span>
                            <span className="text-[10px] font-900 text-[#22c55e] font-display uppercase tracking-tighter">32ms</span>
                        </div>
                        <div className="h-[2px] w-full bg-[#1C1C1A] overflow-hidden">
                            <motion.div 
      ...
      <Card className="bg-[#11110F] border-[#1C1C1A] p-0 overflow-hidden relative shadow-2xl">
        ...
        <div className="p-8 border-b border-[#1C1C1A] bg-[#141412] flex items-center justify-between">
           <div>
              <h3 className="text-[10px] font-900 text-[#F2F0EB] uppercase tracking-[0.4em] font-ui mb-2">High-Velocity Intelligence Matrix</h3>
              <p className="text-[9px] text-[#555550] uppercase tracking-widest font-800">Tracking viral propagation across global nodes</p>
           </div>
           <button onClick={() => onTabChange("articles")} className="px-4 py-2 border border-[#E8A020]/20 hover:bg-[#E8A020]/10 transition-all font-ui text-[9px] font-900 uppercase tracking-widest text-[#E8A020]">
              See All Nodes
           </button>
        </div>
            ...
            {trendingQuery.data?.map((article: any, idx: number) => (
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-4">
                        <span className="text-[8px] font-900 px-2 py-0.5 rounded-sm uppercase tracking-widest text-[#0F0F0E]" style={{ backgroundColor: article.categoryColor || '#555550' }}>
                            {article.category}
                        </span>
                        <div className="flex items-center gap-1.5 text-green-500">
                            <TrendingUp size={12} />
                            <span className="text-[10px] font-900">+{((4 - idx) * 3).toFixed(1)}%</span>
                        </div>
                    </div>
      ...
      <Card className="bg-[#11110F] border-[#1C1C1A] p-8 border-l-4 border-l-[#E8A020]">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
              <div className="flex items-start gap-4 flex-1">
                  ...
                  <div>
                      <h4 className="text-[10px] font-900 text-[#F2F0EB] uppercase tracking-[0.3em] font-ui mb-2">Intelligence Stream Snapshot</h4>
              ...
              <div className="flex items-center gap-4">
                  <button onClick={() => onTabChange("system")} className="flex items-center gap-2 bg-[#1C1C1A] hover:bg-[#E8A020] hover:text-[#0F0F0E] text-[#8A8880] font-ui text-[10px] font-900 uppercase tracking-widest px-6 py-3 transition-all rounded-sm">
                        View Kernel Logs
                  </button>
              </div>
          </div>
