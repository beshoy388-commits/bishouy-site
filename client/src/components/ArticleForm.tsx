...
import { Loader2, Upload, Eye, Edit2, ArrowLeft, Clock, User, Calendar } from "lucide-react";
...
export default function ArticleForm({ articleId, onSuccess }: ArticleFormProps) {
          ...
          <div className="grid gap-6">
            ...
            <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
              <label className="block mb-2">
                <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Title</span>
              </label>
              <input
                type="text"
                name="title"
            ...
            <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
              <label className="block mb-2">
                <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Slug (URL)</span>
              </label>
              <input
                type="text"
                name="slug"
              ...
              />
              <p className="font-ui text-xs text-[#555550] mt-2">Auto-generated from title. This will be the article URL.</p>
            </Card>

            {/* Excerpt */}
            <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
              <label className="block mb-2">
                <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Excerpt</span>
              </label>
              <textarea
                name="excerpt"
              ...
              />
              <p className="font-ui text-xs text-[#555550] mt-2">{formData.excerpt.length}/500</p>
            </Card>

            {/* Content — Rich Text Editor */}
            <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
              <label className="block mb-2">
                <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Content</span>
                <span className="font-ui text-xs text-[#555550] ml-2">Supports Markdown formatting</span>
              </label>
              <RichTextEditor
            ...
            <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
              <label className="block mb-2">
                <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Hero Image</span>
                <span className="font-ui text-xs text-[#555550] ml-2">Main article cover image</span>
              </label>
              <ImageUploader
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
                <label className="block mb-2">
                  <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Category</span>
                </label>
              ...
              <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
                <div className="space-y-4">
                  <div>
                    <label className="block mb-2">
                      <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Author</span>
                    </label>
                    <input
                      type="text"
                      name="author"
                  ...
                  <div>
                    <label className="block mb-2">
                      <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Role</span>
                    </label>
                    <input
                      type="text"
                      name="authorRole"
            ...
            <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
              <label className="block mb-2">
                <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Tags</span>
                <span className="font-ui text-xs text-[#555550] ml-2">Up to 10 tags</span>
              </label>
              ...
              <div className="flex flex-wrap gap-2">
                {formData.tags.map((tag, i) => (
                  <span key={i} className="bg-[#2A2A28] text-[#E8A020] font-ui text-xs px-3 py-1 rounded-sm flex items-center gap-2">
                    #{tag}
                    <button
                      type="button"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="font-ui text-sm text-[#F2F0EB] block">Featured Article</span>
                    <span className="font-ui text-xs text-[#555550]">Shows in hero section</span>
                  </div>
                </label>
              </Card>
              ...
              <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="font-ui text-sm text-[#F2F0EB] block">Breaking News</span>
                    <span className="font-ui text-xs text-[#555550]">Shows in ticker</span>
                  </div>
                </label>
              </Card>
              ...
              <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
                <label className="block mb-2">
                  <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Read Time</span>
                </label>
                <div className="flex items-center gap-2">
                  <Clock size={16} className="text-[#8A8880]" />
                  <span className="text-[#F2F0EB] font-ui text-sm">{formData.readTime} min</span>
                  <span className="text-[#555550] font-ui text-xs">(auto-calculated)</span>
                </div>
              </Card>
              ...
              <Card className="bg-[#1C1C1A] border-[#2A2A28] p-6">
                <label className="block mb-2">
                  <span className="font-ui text-xs font-600 text-[#E8A020] uppercase tracking-widest">Visibility Status</span>
                </label>
