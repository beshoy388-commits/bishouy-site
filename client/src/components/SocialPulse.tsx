        ...
        <Card className="bg-[#11110F] border-[#1C1C1A] overflow-hidden flex flex-col h-full shadow-2xl relative">
            ...
            <div className="p-4 border-b border-[#1C1C1A] flex items-center justify-between bg-[#0A0A09]/80 backdrop-blur-sm relative z-10">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-ui text-[10px] font-black text-[#F2F0EB] uppercase tracking-[0.2em]">
            ...
            {isAuthenticated ? (
                ...
                <div className="p-6 border-b border-[#1C1C1A] text-center bg-[#11110F]/80 backdrop-blur-sm relative overflow-hidden group">
                    ...
                    <p className="text-[10px] font-black text-[#F2F0EB] uppercase tracking-[0.2em] mb-2 relative z-10">Sync with the Pulse</p>
                    ...
                    <Link href="/login" className="inline-block bg-[#E8A020] text-[#0F0F0E] text-[9px] font-black uppercase tracking-widest px-6 py-2 rounded-sm hover:scale-105 active:scale-95 transition-all relative z-10">
                        Join Community
                    </Link>
                </div>
            )}
                                    ...
                                    <div className="flex items-center justify-between mb-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {post.authorRole === 'admin' && (
                                                <Badge variant="outline" className="h-4 border-[#E8A020]/30 text-[#E8A020] text-[8px] font-black px-1.5 uppercase tracking-tighter shadow-[0_0_10px_rgba(232,160,32,0.1)]">ROOT</Badge>
                                            )}
                                            {post.authorId && post.authorId < 100 && (
                                                <Badge variant="outline" className="h-4 border-[#8A8880]/30 text-[#8A8880] text-[7px] font-extrabold px-1.5 uppercase tracking-tighter opacity-70">Founding</Badge>
                                            )}
                                        </div>
