...
export default function ArticleDetail() {
  ...
  const renderArticleContent = (content: string) => {
    ...
    // Standardize blockquotes: ensure there's a space after > and a newline before the blockquote
    // This fixes cases where the markdown parser would otherwise see raw text
      ...
      return (
        <ReactMarkdown
          ...
          components={{
            ...
            blockquote: ({ children }) => (
              <blockquote className="premium-blockquote article-blockquote">
                {children}
              </blockquote>
            ),
            a: ({ href, children }) => (
