            ...
            <div className="min-h-screen bg-[#0F0F0E] flex flex-col font-sans text-[#F2F0EB]">
                ...
                <main className="flex-1 flex items-center justify-center p-4">
                    <div className="text-center">
                        <h1 className="text-2xl font-headline text-red-500 mb-2">Invalid Link</h1>
                        <p className="text-[#8A8880] mb-6">The password reset token is missing or invalid.</p>
            ...
            <main className="flex-1 flex items-center justify-center p-4">
                <div className="w-full max-w-md bg-[#1C1C1A] border border-[#2A2A28] rounded-sm p-8 shadow-2xl">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-headline text-[#E8A020] mb-2">Create New Password</h1>
                    ...
                    {isSuccess ? (
                        <div className="text-center">
                            ...
                            <h2 className="text-xl font-medium text-[#F2F0EB] mb-2">Password Reset Successful!</h2>
