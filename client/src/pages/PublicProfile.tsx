...
import { User, Calendar, Link as LinkIcon, MapPin, Loader2, Shield } from "lucide-react";
        ...
        return (
            <div className="min-h-screen bg-[#0F0F0E] flex flex-col">
                ...
                <main className="flex-1 flex flex-col items-center justify-center text-center px-4">
                    <h1 className="font-display text-4xl text-[#E8A020] mb-4">User Not Found</h1>
                    <p className="text-[#8A8880] mb-8">The profile you are looking for does not exist.</p>
                </main>
                <Footer />
            </div>
        );
            ...
            <main className="flex-1 container pt-32 pb-16">
                <div className="max-w-3xl mx-auto">
                    <div className="bg-[#1C1C1A] border border-[#2A2A28] p-8 md:p-12 flex flex-col items-center text-center">
                        ...
                        <h1 className="font-display text-4xl text-[#F2F0EB] mb-2">{profile.name}</h1>
                        ...
                        <div className="flex flex-wrap justify-center gap-6 text-[#8A8880] text-sm font-ui border-t border-[#2A2A28] pt-8 w-full">
                            ...
                            {profile.website && (
                                <div className="flex items-center gap-2">
                                    ...
                                    <a href={profile.website} target="_blank" rel="noopener noreferrer" className="hover:text-[#E8A020] transition-colors">
                                        Website
                                    </a>
                                </div>
                            )}
