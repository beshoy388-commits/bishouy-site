            ...
            <main className="flex-1 flex items-center justify-center p-4">
                <div className="w-full max-w-md bg-[#1C1C1A] border border-[#2A2A28] rounded-sm p-8 shadow-2xl">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-headline text-[#E8A020] mb-2">Reset Password</h1>
                    ...
                    {isSuccess ? (
                        <div className="text-center">
                            ...
                            <h2 className="text-xl font-medium text-[#F2F0EB] mb-2">Check your email</h2>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="bg-[#E8A020]/10 border border-[#E8A020]/20 rounded-sm p-4 flex items-start gap-3">
                                <ShieldAlert className="text-[#E8A020] flex-shrink-0 mt-0.5" size={16} />
                                <p className="text-xs text-[#8A8880] leading-relaxed">
                                    For security reasons, you can only request a password reset a limited number of times per hour.
