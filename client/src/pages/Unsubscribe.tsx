...
export default function Unsubscribe() {
    ...
    const content = {
        success: {
            ...
            message: "We're sorry to see you go. Your email has been removed from our newsletter list immediately. You won't receive any further emails from us.",
            cta: "You can resubscribe at any time from our homepage.",
        },
        notfound: {
            icon: <AlertCircle size={56} className="text-[#E8A020] mx-auto" />,
            title: "Link already used.",
            message: "This unsubscribe link has already been used or is no longer valid. If you're still receiving emails, please contact us.",
            cta: null,
        },
        error: {
            icon: <XCircle size={56} className="text-red-500 mx-auto" />,
            title: "Something went wrong.",
            message: "We couldn't process your request. Please try again or contact us at privacy@bishouy.com.",
            cta: null,
        },
        loading: {
            icon: null,
    ...
    return (
        <div className="min-h-screen bg-[#0F0F0E]">
            ...
            <main className="container pt-40 pb-24 flex items-center justify-center">
                <div className="max-w-lg w-full text-center">
                    ...
                    {/* CTA note */}
                    {cta && (
                        <p className="font-ui text-sm text-[#555550] mb-8">{cta}</p>
                    )}
