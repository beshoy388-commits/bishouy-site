            ...
            <main className="container pt-32 pb-16 flex items-center justify-center">
                <div className="w-full max-w-md bg-[#1C1C1A] border border-[#2A2A28] p-8 rounded-sm">
                    <div className="text-center mb-8">
                        <h1 className="font-display text-3xl text-[#F2F0EB] mb-2">WELCOME BACK</h1>
                        <p className="font-ui text-sm text-[#8A8880]">Sign in to comment and like articles.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-end mt-2">
                                <Link href="/forgot-password" className="text-[10px] text-[#8A8880] hover:text-[#E8A020] transition-colors uppercase tracking-widest font-ui font-600">
                                    Forgot Password?
                                </Link>
                            </div>
                        </div>
                    ...
                    <p className="mt-8 text-center font-ui text-xs text-[#555550]">
                        ...
                        <Link href="/register" className="text-[#E8A020] hover:underline font-600">
                            Register now
                        </Link>
                    </p>
                </div>
